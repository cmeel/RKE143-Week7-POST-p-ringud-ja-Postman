...
app.get('/', (req, res) => {
    const randomIndex = Math.floor(Math.random() * pumpkinInData.Categories['Pumpkin Drinks'].length);
    const randomDrinkRecipe = pumpkinInData.Categories['Pumpkin Drinks'][randomIndex];
